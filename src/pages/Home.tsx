        ...
        <div className="h-full w-dvw font-sans">
            ...
            <div className="h-full flex flex-col items-center px-10 py-10 sm:py-20 md:py-30">
                <div className="flex flex-col">
                    <h3 className="font-bold  text-white text-2xl sm:text-4xl md:text-6xl lg:text-8xl">Liri Sobol</h3>
                    <p className="font-light text-white text-xl sm:text-2xl md:text-4xl lg:text-6xl">
